          ...
          bugPromise.then(() => {
            if (currentColor && currentColor !== 'white') {
              ...
              switch (currentColor) {
                ...
                case 'yellow':
                  ...
                  const yellowPatterns = [
                    { params: [10000, 1, 0.2, 700, 30], desc: "20%0.7秒30回" },
                    { params: [10000, 1, 0.5, 1500, 60], desc: "50%1.5秒60回" },
                    { params: [10000, 1, 0.3, 2000, 45], desc: "30%2秒45回" },
                    { params: [10000, 1, 0.05, 500, 50], desc: "5%0.5秒50回" },
              ...
              const whitePatterns = [
                ...
                { params: [2500, 35], desc: "2.5秒で35回" },
                { params: [2000, 45], desc: "2秒で45回" },
                { params: [2500, 30], desc: "2.5秒で30回" },
                { params: [2000, 35], desc: "2秒で35回" },
                { params: [1500, 25], desc: "1.5秒で25回" },
                { params: [1300, 23], desc: "1.3秒で23回" },
